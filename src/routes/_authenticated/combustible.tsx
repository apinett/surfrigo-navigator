...
export const Route = createFileRoute("/_authenticated/combustible")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Módulo previsto para litros cargados, rendimiento por unidad y consumo por ruta.",
      },
      { property: "og:title", content: "Combustible y rendimiento | Surfrigo Control Tower" },
      {
        property: "og:description",
        content: "Próximo módulo: litros, rendimiento por unidad y consumo por ruta.",
      },
    ],
  }),
  component: () => (
