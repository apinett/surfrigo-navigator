...
export const DRIVERS: Driver[] = [
  {
    ...
    phone: "+54 9 11 4000 0101",
    role: "titular",
    kmPeriod: 9840,
    kmTarget: 12000,
    restDaysAvailable: 2,
    lastDestinationId: "bahia",
    status: "activo",
  },
  {
    id: "d02",
    ...
    homeCity: "Neuquén",
    province: "Neuquén",
    phone: "+54 9 299 400 0102",
    role: "titular",
    kmPeriod: 7420,
    kmTarget: 12000,
    restDaysAvailable: 1,
    lastDestinationId: "neuquen",
    status: "activo",
  },
  {
    id: "d03",
    name: "Damián Ledesma",
    homeCity: "Bahía Blanca",
    province: "Buenos Aires",
    phone: "+54 9 291 400 0103",
    role: "titular",
    kmPeriod: 11380,
    kmTarget: 12000,
    restDaysAvailable: 0,
    lastDestinationId: "trelew",
    status: "activo",
  },
  {
    id: "d04",
    ...
    homeCity: "Trelew",
    province: "Chubut",
    phone: "+54 9 280 400 0104",
    role: "titular",
    kmPeriod: 12960,
    kmTarget: 12000,
    restDaysAvailable: 2,
    lastDestinationId: "montt",
    status: "activo",
  },
  {
    id: "d05",
    name: "Nicolás Ferrari",
    homeCity: "Luján",
    province: "Buenos Aires",
    phone: "+54 9 11 4000 0105",
    role: "titular",
    kmPeriod: 6120,
    kmTarget: 12000,
    restDaysAvailable: 3,
  ...
  },
  {
    ...
    homeCity: "Bariloche",
    province: "Río Negro",
    phone: "+54 9 294 400 0106",
    role: "titular",
    kmPeriod: 10240,
    kmTarget: 12000,
    restDaysAvailable: 1,
    lastDestinationId: "bariloche",
    status: "activo",
  },
  {
    id: "d07",
    name: "Julián Peralta",
    homeCity: "Río Gallegos",
    province: "Santa Cruz",
    phone: "+54 9 2966 40 0107",
    role: "titular",
    kmPeriod: 13480,
    kmTarget: 12000,
    restDaysAvailable: 0,
    lastDestinationId: "gallegos",
    status: "activo",
  },
  {
    id: "d08",
    ...
    homeCity: "Zárate",
    province: "Buenos Aires",
    phone: "+54 9 3487 40 0108",
    role: "titular",
    kmPeriod: 8360,
    kmTarget: 12000,
    restDaysAvailable: 2,
    lastDestinationId: "chacabuco",
    status: "activo",
  },
  {
    id: "d09",
    ...
    phone: "+54 9 2964 40 0109",
    role: "titular",
    kmPeriod: 12140,
    kmTarget: 12000,
    restDaysAvailable: 1,
    lastDestinationId: "grande",
    status: "activo",
  },
  {
    id: "d10",
  ...
  },
  {
    ...
    homeCity: "Bahía Blanca",
    province: "Buenos Aires",
    phone: "+54 9 291 400 0111",
    role: "titular",
    kmPeriod: 9020,
    kmTarget: 12000,
    restDaysAvailable: 2,
    lastDestinationId: "quellon",
    status: "activo",
  },
  {
    id: "d12",
  ...
  },
  {
    ...
    homeCity: "Neuquén",
    province: "Neuquén",
    phone: "+54 9 299 400 0114",
    role: "titular",
    kmPeriod: 11760,
    kmTarget: 12000,
    restDaysAvailable: 0,
    lastDestinationId: "arenas",
    status: "activo",
  },
  {
    id: "d15",
    name: "Pablo Cáceres",
    homeCity: "Comodoro Rivadavia",
    province: "Chubut",
    phone: "+54 9 297 400 0115",
    role: "titular",
    kmPeriod: 8890,
    kmTarget: 12000,
    restDaysAvailable: 2,
  ...
  },
  {
    ...
    homeCity: "San Justo",
    province: "Buenos Aires",
    phone: "+54 9 11 4000 0116",
    role: "titular",
    kmPeriod: 7310,
    kmTarget: 12000,
    restDaysAvailable: 2,
    lastDestinationId: "natales",
    status: "activo",
  },
  {
    id: "d17",
  ...
  },
  {
    ...
    homeCity: "Pilar",
    province: "Buenos Aires",
    phone: "+54 9 230 400 0118",
    role: "titular",
    kmPeriod: 6740,
    kmTarget: 12000,
    restDaysAvailable: 3,
    lastDestinationId: "calbuco",
    status: "activo",
  },
  {
    id: "r01",
...
const transito = (
  ...
  span: number,
  eta: string,
  status: OperationStatus = "transito",
): Segment => ({
  status,
  span,
...
const UNIT_SEEDS: UnitSeed[] = [
  {
    code: "201",
    tractorPlate: "AF 412 KL",
    trailerPlate: "SR 118 TR",
    driverId: "d01",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "bahia",
    lastDestinationId: "bahia",
    kmPeriod: 9840,
    startDay: 0,
    chain: [
  ...
  {
    code: "204",
    tractorPlate: "AE 776 QP",
    trailerPlate: "SR 121 TR",
    driverId: "d02",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "neuquen",
    lastDestinationId: "neuquen",
    kmPeriod: 7420,
    startDay: 0,
    chain: [
  ...
  {
    code: "207",
    tractorPlate: "AD 093 MN",
    trailerPlate: "SR 130 TR",
    driverId: "d03",
    trailerType: "Frigorífico 28 pallets",
    currentLocationId: "trelew",
    lastDestinationId: "trelew",
    kmPeriod: 11380,
    startDay: 0,
    chain: [
      ...
      transito("trelew", "ezeiza", 2, "Sáb 12:00"),
      {
        status: "taller",
        span: 1,
        title: "Taller CD Ezeiza",
        subtitle: "Service 90.000 km",
        toId: "taller",
        tooltip: "Puesta a punto antes del próximo viaje.",
      },
    ],
  },
  {
    code: "212",
    tractorPlate: "AG 552 RT",
    trailerPlate: "SR 142 TR",
    driverId: "d04",
    reliefDriverId: "r01",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "montt",
    lastDestinationId: "montt",
    kmPeriod: 12960,
    startDay: 0,
    chain: [
      {
        status: "cargando",
        span: 1,
        title: "Carga Puerto Montt",
        subtitle: "Salmón fresco · 26 pallets",
        fromId: "montt",
        toId: "ezeiza",
        tooltip: "Carga en planta de proceso. Se comunica al cliente al salir.",
      },
      {
        status: "retorno_chile",
        span: 2,
        title: "Puerto Montt → Cardenal Samoré",
        subtitle: "ETA paso Mié 11:00",
        fromId: "montt",
        toId: "cardenal",
        tooltip: "Retorno Chile con ETA dinámico.",
      },
      {
        status: "frontera",
        span: 1,
        title: "Cardenal Samoré",
        subtitle: "Trámite ~90 min",
        toId: "cardenal",
        risk: "bajo",
        tooltip: "Paso abierto 08:00–22:00. Corte documental 21:00.",
      },
  ...
  {
    code: "215",
    tractorPlate: "AC 318 BZ",
    trailerPlate: "SR 149 TR",
    driverId: "d05",
    trailerType: "Isotérmico",
    currentLocationId: "ezeiza",
    lastDestinationId: "bahia",
    kmPeriod: 6120,
    startDay: 0,
    chain: [
  ...
  {
    code: "218",
    tractorPlate: "AF 901 HK",
    trailerPlate: "SR 155 TR",
    driverId: "d06",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "bariloche",
    lastDestinationId: "bariloche",
    kmPeriod: 10240,
    startDay: 0,
    chain: [
      ...
      disponible("bariloche", 1, "Chofer domiciliado en Bariloche"),
      {
        status: "cargando",
        span: 1,
        title: "Reposicionamiento a Puerto Montt",
        subtitle: "Vacío · cruce Samoré",
        fromId: "bariloche",
        toId: "montt",
      },
  ...
  {
    code: "221",
    tractorPlate: "AD 447 CV",
    trailerPlate: "SR 160 TR",
    driverId: "d07",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "gallegos",
    lastDestinationId: "gallegos",
    kmPeriod: 13480,
    startDay: 0,
    chain: [
      ...
      disponible("gallegos", 1, "Chofer sobre meta de km"),
      {
        status: "demorada",
        span: 2,
        title: "Río Gallegos → Ezeiza",
        subtitle: "Demora por viento en RN3",
        fromId: "gallegos",
        toId: "ezeiza",
        risk: "medio",
        tooltip: "ETA original Sáb 08:00, revisado Dom 04:00.",
      },
      disponible("ezeiza", 1),
    ],
  },
  {
    code: "224",
    tractorPlate: "AG 205 DF",
    trailerPlate: "SR 166 TR",
    driverId: "d08",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "chacabuco",
    lastDestinationId: "chacabuco",
    kmPeriod: 8360,
    startDay: 0,
    chain: [
      disponible("chacabuco", 1, "Esperando embarque de planta"),
      {
        status: "cargando",
        span: 1,
        title: "Carga Puerto Chacabuco",
        subtitle: "Salida 17:00",
        fromId: "chacabuco",
        toId: "ezeiza",
      },
      {
        status: "riesgo",
        span: 1,
        title: "Riesgo cruce Balmaceda",
        subtitle: "ETA paso 20:10 · cierre 20:00",
        fromId: "chacabuco",
        toId: "balmaceda",
        risk: "alto",
        tooltip: "Trayecto ~3 h. Presentación de papeles hasta 19:30. Probabilidad de cruce 18%.",
      },
      {
        status: "frontera",
        span: 1,
        title: "Balmaceda — reapertura 08:00",
        subtitle: "Trámite estimado 09:15",
        toId: "balmaceda",
        risk: "medio",
        tooltip: "ETA recalculado por no cruce: liberación Vie 09:15.",
      },
  ...
  {
    code: "227",
    tractorPlate: "AE 660 JN",
    trailerPlate: "SR 171 TR",
    driverId: "d09",
    trailerType: "Frigorífico 28 pallets",
    currentLocationId: "grande",
    lastDestinationId: "grande",
    kmPeriod: 12140,
    startDay: 0,
    chain: [
  ...
  {
    code: "230",
    tractorPlate: "AF 128 SW",
    trailerPlate: "SR 178 TR",
    driverId: "d10",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "ezeiza",
    lastDestinationId: "neuquen",
    ...
    chain: [
      {
        ...
        span: 2,
        title: "Taller CD Ezeiza",
        subtitle: "Equipo de frío · termostato",
        toId: "taller",
        tooltip: "Reparación de equipo de frío. Sale del taller miércoles.",
      },
  ...
  {
    code: "233",
    tractorPlate: "AC 774 PL",
    trailerPlate: "SR 184 TR",
    driverId: "d11",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "quellon",
    lastDestinationId: "quellon",
    kmPeriod: 9020,
    startDay: 0,
    chain: [
      {
        ...
        span: 1,
        title: "Carga Quellón",
        subtitle: "Salmón congelado · 28 pallets",
        fromId: "quellon",
        toId: "ezeiza",
      },
      {
        status: "retorno_chile",
        span: 2,
        title: "Quellón → Cardenal Samoré",
        subtitle: "ETA paso Mié 16:00",
        fromId: "quellon",
        toId: "cardenal",
      },
      {
  ...
  {
    code: "236",
    tractorPlate: "AG 019 XT",
    trailerPlate: "SR 190 TR",
    driverId: "d12",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "bariloche",
    lastDestinationId: "bariloche",
  ...
  {
    code: "239",
    tractorPlate: "AD 583 GH",
    trailerPlate: "SR 195 TR",
    driverId: "d13",
    trailerType: "Isotérmico",
    currentLocationId: "ezeiza",
    lastDestinationId: "bahia",
  ...
  {
    code: "242",
    tractorPlate: "AF 337 NB",
    trailerPlate: "SR 201 TR",
    driverId: "d14",
    reliefDriverId: "r02",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "arenas",
    lastDestinationId: "arenas",
    kmPeriod: 11760,
    startDay: 0,
    chain: [
      {
        status: "cargando",
        span: 1,
        title: "Carga Punta Arenas",
        subtitle: "Salmón fresco · 24 pallets",
        fromId: "arenas",
        toId: "ezeiza",
      },
      {
        status: "retorno_chile",
        span: 1,
        title: "Punta Arenas → Integración Austral",
        subtitle: "ETA paso Mar 14:00",
        fromId: "arenas",
        toId: "integracion",
      },
      {
        status: "frontera",
        span: 1,
        title: "Integración Austral",
        subtitle: "Liberado 15:20",
        toId: "integracion",
        risk: "bajo",
      },
  ...
  {
    code: "245",
    tractorPlate: "AE 245 KD",
    trailerPlate: "SR 208 TR",
    driverId: "d15",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "ezeiza",
    lastDestinationId: "trelew",
    ...
    chain: [
      transito("trelew", "ezeiza", 1, "Lun 21:00"),
      {
        status: "taller",
        span: 1,
        title: "Taller — revisión rápida",
        subtitle: "Neumáticos y frío",
        toId: "taller",
      },
      disponible("ezeiza", 2, "Candidata recomendada a Neuquén"),
      {
        status: "programada",
        span: 1,
        title: "Programada → Neuquén",
        subtitle: "Salida Vie 13:00",
        fromId: "ezeiza",
        toId: "neuquen",
        tooltip: "Recomendación del sistema aceptada por el analista.",
      },
      transito("ezeiza", "neuquen", 2, "Dom 06:00"),
    ],
  },
  {
    code: "248",
    tractorPlate: "AC 902 VR",
    trailerPlate: "SR 214 TR",
    driverId: "d16",
    trailerType: "Frigorífico 28 pallets",
    currentLocationId: "natales",
    lastDestinationId: "natales",
    kmPeriod: 7310,
    startDay: 0,
    chain: [
      ...
      },
      {
        status: "retorno_chile",
        span: 1,
        title: "Natales → Dorotea",
        subtitle: "ETA paso Mié 15:30",
        fromId: "natales",
        toId: "dorotea",
      },
      {
        ...
        toId: "dorotea",
        risk: "medio",
        tooltip: "Falta remito SENASA para liberar el trámite.",
      },
  ...
  {
    code: "251",
    tractorPlate: "AG 671 LM",
    trailerPlate: "SR 219 TR",
    driverId: "d17",
    reliefDriverId: "r01",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "ezeiza",
    ...
    chain: [
      disponible("ezeiza", 1, "Titular en descanso · relevo asignado"),
      {
        ...
        span: 2,
        title: "Taller CD Ezeiza",
        subtitle: "Service mayor programado",
        toId: "taller",
      },
      disponible("ezeiza", 1),
  ...
  {
    code: "254",
    tractorPlate: "AF 088 TQ",
    trailerPlate: "SR 226 TR",
    driverId: "d18",
    trailerType: "Frigorífico 30 pallets",
    currentLocationId: "calbuco",
    lastDestinationId: "calbuco",
    kmPeriod: 6740,
    startDay: 0,
    chain: [
      transito("ezeiza", "calbuco", 3, "Mié 12:00"),
      {
        ...
        span: 1,
        title: "Carga Calbuco",
        subtitle: "Salmón fresco · 27 pallets",
        fromId: "calbuco",
        toId: "ezeiza",
      },
      {
        status: "retorno_chile",
        span: 2,
        title: "Calbuco → Cardenal Samoré",
        subtitle: "ETA paso Sáb 20:00",
        fromId: "calbuco",
        toId: "cardenal",
      },
      {
      ...
      if (["transito", "retorno_chile", "programada"].includes(segment.status) && fromId && toId) {
        ...
        trips.push({
          ...
          etaAt: at(
            weekStart,
            Math.min(day + span, 6),
            segment.status === "demorada" ? "10:30" : "06:00",
          ),
          marginMinutes: segment.status === "demorada" ? -270 : 60 + ((seedIndex * 37) % 180),
          cargo:
            segment.status === "retorno_chile" ? "Salmón refrigerado" : "Consolidado aéreo Ezeiza",
          km: km || 620,
...
const buildAlerts = (weekStart: string): Alert[] => [
  {
    id: "a1",
    kind: "riesgo_frontera",
    severity: "critica",
    unitId: "u-224",
    title: "Unidad 224 · riesgo alto de no cruzar Balmaceda",
    detail:
      "Salida Puerto Chacabuco 17:00, trayecto ~3 h. ETA paso 20:10 y cierre 20:00 (papeles hasta 19:30). Probabilidad de cruce 18%.",
    createdAt: at(weekStart, 2, "17:12"),
    suggestedAction:
      "Avisar al cliente riesgo alto y recalcular ETA a reapertura 08:00 del jueves.",
  },
  {
    id: "a2",
    kind: "salida_comprometida",
    severity: "critica",
    title: "Salida Ezeiza → Neuquén del viernes sin unidad firme",
    detail:
      "El previsto de depósito pide salida viernes 13:00 con llegada domingo 06:00. Hoy no hay unidad confirmada en CD.",
  ...
  {
    id: "a5",
    kind: "deberia_estar_disponible",
    severity: "media",
    unitId: "u-227",
    title: "Unidad 227 debería estar disponible y sigue en viaje",
    detail:
      "Planificada como disponible en Río Grande el jueves; el tránsito ocupa hasta jueves 10:00.",
    createdAt: at(weekStart, 3, "07:30"),
    suggestedAction: "Confirmar hora real de descarga antes de comprometer el retorno.",
  },
  {
    id: "a6",
    kind: "sin_proximo_viaje",
    severity: "media",
    unitId: "u-239",
    title: "Unidad 239 sin próximo viaje asignado",
    detail:
      "Disponible en CD Ezeiza desde el lunes. Chofer 4.260 km, muy por debajo de la meta del período.",
...
const buildUpcoming = (weekStart: string): UpcomingMovement[] => [
  {
    id: "n1",
    unitId: "u-224",
    locationId: "chacabuco",
    nextDestinationId: "balmaceda",
    etaAt: at(weekStart, 2, "20:10"),
    window: "24h",
    status: "riesgo",
    suggestedAction: "Comunicar riesgo de cruce y preparar ETA alternativo 08:00.",
  },
  {
    id: "n2",
    unitId: "u-212",
    locationId: "montt",
    nextDestinationId: "cardenal",
    etaAt: at(weekStart, 2, "11:00"),
    window: "24h",
    status: "retorno_chile",
    suggestedAction: "Enviar documentación al despachante del paso.",
  },
  {
    id: "n3",
    unitId: "u-245",
    locationId: "ezeiza",
    nextDestinationId: "neuquen",
    etaAt: at(weekStart, 4, "13:00"),
    window: "48h",
    status: "programada",
    suggestedAction: "Confirmar carga en muelle 4 y notificar al chofer.",
  },
  {
    id: "n4",
    unitId: "u-233",
    locationId: "cardenal",
    nextDestinationId: "ezeiza",
    etaAt: at(weekStart, 3, "07:30"),
    window: "24h",
    status: "retorno_chile",
    suggestedAction: "Avisar a embarcadores de Ezeiza ETA sábado 06:00.",
  },
  {
    id: "n5",
    unitId: "u-230",
    locationId: "taller",
    nextDestinationId: "ezeiza",
    etaAt: at(weekStart, 2, "16:00"),
    window: "24h",
    status: "taller",
    suggestedAction: "Verificar salida de taller para liberar la unidad.",
  },
  {
    id: "n6",
    unitId: "u-221",
    locationId: "gallegos",
    nextDestinationId: "ezeiza",
    etaAt: at(weekStart, 6, "04:00"),
    window: "48h",
    status: "demorada",
    suggestedAction: "Reprogramar turno de descarga por demora de 4h 30m.",
  },
];
...
const buildBorderEvents = (weekStart: string): BorderEvent[] => [
  {
    id: "b1",
    unitId: "u-224",
    borderCrossingId: "balmaceda",
    departedFromId: "chacabuco",
    departedAt: at(weekStart, 2, "17:10"),
    etaBorderAt: at(weekStart, 2, "20:10"),
    crossProbability: 0.18,
    outcome: "riesgo",
  ...
  },
  {
    id: "b2",
    unitId: "u-212",
    borderCrossingId: "cardenal",
    departedFromId: "montt",
    departedAt: at(weekStart, 1, "22:00"),
    etaBorderAt: at(weekStart, 2, "11:00"),
    paperworkSentAt: at(weekStart, 2, "08:20"),
    crossProbability: 0.94,
    outcome: "pendiente",
  },
  {
    id: "b3",
    unitId: "u-233",
    borderCrossingId: "cardenal",
    departedFromId: "quellon",
    departedAt: at(weekStart, 1, "06:30"),
    etaBorderAt: at(weekStart, 2, "16:00"),
    paperworkSentAt: at(weekStart, 2, "12:10"),
    crossProbability: 0.88,
    outcome: "cruzo",
  ...
  },
  {
    id: "b4",
    unitId: "u-248",
    borderCrossingId: "dorotea",
    departedFromId: "natales",
    departedAt: at(weekStart, 2, "12:00"),
    etaBorderAt: at(weekStart, 2, "15:30"),
    crossProbability: 0.55,
    outcome: "pendiente",
    comment: "Documentación SENASA pendiente.",
  },
  {
    id: "b5",
    unitId: "u-242",
    borderCrossingId: "integracion",
    departedFromId: "arenas",
    departedAt: at(weekStart, 1, "09:00"),
    etaBorderAt: at(weekStart, 1, "14:00"),
    paperworkSentAt: at(weekStart, 1, "10:30"),
    crossProbability: 0.96,
    outcome: "cruzo",
...
const buildCommunications = (weekStart: string): CommunicationDraft[] => [
  {
    ...
    unitId: "u-224",
    audience: "cliente",
    trigger: "Salida de puerto con riesgo de cruce",
  ...
  },
  {
    ...
    unitId: "u-212",
    audience: "embarcador",
    trigger: "ETA a Ezeiza confirmado",
  ...
  },
  {
    ...
    unitId: "u-248",
    audience: "senasa",
    trigger: "Documentación pendiente",
...
export const buildWeeklyPlan = (offset: number): WeeklyPlan => {
  ...
  const activeToday = (status: OperationStatus) =>
    movements.filter(
      (m) => m.status === status && today >= m.dayIndex && today < m.dayIndex + m.span,
    ).length;
