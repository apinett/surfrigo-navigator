...
export const LOCATIONS: LocationNode[] = [
  { id: "ezeiza", name: "CD Ezeiza", kind: "cd", country: "AR", province: "Buenos Aires", kmFromEzeiza: 0, transitHours: 0 },
  { id: "bahia", name: "Bahía Blanca", kind: "base", country: "AR", province: "Buenos Aires", kmFromEzeiza: 640, transitHours: 9 },
  { id: "neuquen", name: "Neuquén", kind: "base", country: "AR", province: "Neuquén", kmFromEzeiza: 1160, transitHours: 16 },
  { id: "bariloche", name: "Bariloche", kind: "base", country: "AR", province: "Río Negro", kmFromEzeiza: 1620, transitHours: 22 },
  { id: "trelew", name: "Trelew", kind: "base", country: "AR", province: "Chubut", kmFromEzeiza: 1380, transitHours: 19 },
  { id: "gallegos", name: "Río Gallegos", kind: "base", country: "AR", province: "Santa Cruz", kmFromEzeiza: 2620, transitHours: 36 },
  { id: "grande", name: "Río Grande", kind: "base", country: "AR", province: "Tierra del Fuego", kmFromEzeiza: 3060, transitHours: 44 },
  { id: "montt", name: "Puerto Montt", kind: "puerto", country: "CL", kmFromEzeiza: 1980, transitHours: 28 },
  { id: "calbuco", name: "Calbuco", kind: "puerto", country: "CL", kmFromEzeiza: 2030, transitHours: 29 },
  { id: "quellon", name: "Quellón", kind: "puerto", country: "CL", kmFromEzeiza: 2210, transitHours: 32 },
  { id: "chacabuco", name: "Puerto Chacabuco", kind: "puerto", country: "CL", kmFromEzeiza: 2460, transitHours: 34 },
  { id: "arenas", name: "Punta Arenas", kind: "puerto", country: "CL", kmFromEzeiza: 2890, transitHours: 40 },
  { id: "natales", name: "Puerto Natales", kind: "puerto", country: "CL", kmFromEzeiza: 2740, transitHours: 38 },
  { id: "taller", name: "Taller CD Ezeiza", kind: "taller", country: "AR", province: "Buenos Aires", kmFromEzeiza: 0 },
];
